        ...
        <div className="shrink-0 md:w-1/2 lg:w-7/12 xl:w-auto">
          ...
          >
            <motion.li variants={list} className="flex gap-3">
              ...
              <span>
                Transform Your Educational with Scope’s AI-Driven Solutions.
              </span>
            </motion.li>
            <motion.li variants={list} className="flex gap-3">
              <svg
            ...
            <motion.li variants={list} className="flex gap-3">
              ...
              <span>
                Elevate Your Future with Scope: Your All-in-One Education
                Partner.
              </span>
            </motion.li>
            <motion.li variants={list} className="flex gap-3">
              ...
              <span>Build, Code, and Connect</span>
            </motion.li>
          </motion.ul>
          <motion.div
            initial={{ opacity: 0 }}
