  ...
  return (
    <div className="relative z-20">
      <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 pt-24">
        ...
        >
          Navigate Your Educational Path with Confidence – Explore Scope’s Smart
          Features.
        </motion.p>
          ...
          <div className="relative text-sm max-w-lg">
            ...
            >
              ...
              <span className="flex gap-1.5 items-center mt-2">
                ...
                <span>Without Scope</span>
              </span>
              <span className="flex gap-1.5 items-center mt-2">
                <span className="text-green-400">-</span>
                <span>With Scope</span>
              </span>
            </motion.div>
          </div>
                ...
                <button className="text-white flex gap-4 items-center text-left relative">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-zinc-400">
                      From Resumes to Hackathons – Scope has Your Educational
                      Needs Covered.
                    </div>
                  </div>
                </button>
